...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Role restriction
        if (!interaction.member.roles.cache.some(role => STAFF_ROLE_IDS.includes(role.id))) {
        ...
        try {
            ...
            await interaction.reply({
                content: `✅ Successfully DM'd ${user.tag} and logged the interaction.`,
                flags: MessageFlags.Ephemeral,
            });
            ...
            await interaction.reply({
                content: '❌ There was an error sending the DM or logging the interaction.',
                flags: MessageFlags.Ephemeral,
            });
        }
    }
